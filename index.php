...
if((!$viewAttachment) && (!$viewAttachment && $action != 'home_rss') && $action != 'Tickerdetail' && $action != $Ajx_module."Ajax" && $action != "chat" && $action != "HeadLines" && $action != 'massdelete'  &&  $action != "DashboardAjax" && $action != "ActivityAjax")
{
	...
	
	{
		...
		echo "<tr><td class=small align=left><span style='color: rgb(153, 153, 153);'>Powered by zg@hntri.com</span></td>";
		echo "<td class=small align=right><span>&copy; 2011-".date('Y')." <a href='http://bg.hntri.com/xxs' target='_blank'>交科院信息研究所</a> </span> </td></tr></table>";
