...
<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class="small">
	<tr>
		...
		<td valign=top align=left><img src="test/logo/{$LOGO}" alt="" title="" border=0></td>
		...
		<td class=small nowrap align="right" style="padding-right:10px;">
			...
			<tr>
				<!-- <td valign="top" class="genHeaderSmall" style="padding-left:10px;padding-top:3px;">
					当前用户：<span class="userName">{$USER}</span>
				</td> -->
				<td valign="top" style="padding-left:5px;padding-top:3px;">
					当前用户：<span class="userName">{$USER}</span>
				</td>
				<!-- 修改小图标下拉菜单设计，屏蔽用户设定 -->
				<td valign="top" style="padding-left:10px;padding-top:3px;"><a href="index.php?module=Users&action=Logout">{$APP.LBL_LOGOUT}</a> </td>
				 <td valign="top" style="padding-left:10px;padding-top:3px;"><a href="index.php?module=Users&action=DetailView&record={$USERID}&modechk=prefview">{$APP.LBL_MY_PREFERENCES}</a></td>
