   	...
   	<tr>
		...
		{foreachelse}
					...
					<script>redirectWhenNoRelatedRecordsFound();</script>
                                        <td style="border-bottom: 1px solid rgb(204, 204, 204);" nowrap="nowrap" width="75%"><span class="genHeaderSmall">{$MODULE|@getTranslatedString:$MODULE}: {$APP.LBL_RECORD_NOT_FOUND}!</td>
                                        {else}
                                        <td style="border-bottom: 1px solid rgb(204, 204, 204);" nowrap="nowrap" width="75%"><span class="genHeaderSmall">{$MODULE|@getTranslatedString:$MODULE}:{$APP.LBL_RECORD_NOT_FOUND}!</td>
                                        {/if}
                                </tr>
